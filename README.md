...
旧版本默认将应用安装在单独的容器中，新版变更了该项功能，默认将所有应用都安装到了 $home/.wine 下，你需要使用 --ioslate 参数激活旧版本功能（例：winetrick --isolate qq）。如果你不喜欢上游的改动，请到 https://github.com/Winetricks/winetricks/issues/494 加入讨论。
